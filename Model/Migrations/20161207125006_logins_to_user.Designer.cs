...
namespace PassarinhoContou.Model.Migrations
{
    ...
    [Migration("20161207125006_logins_to_user")]
    partial class logins_to_user
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("PassarinhoContou.Model.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("PassarinhoContou.Model.Message", b =>
                {
                    b.HasOne("PassarinhoContou.Model.User", "FromUser")
                    ...
                    b.HasOne("PassarinhoContou.Model.User", "ToUser")
