...
public class SelectContactFragment extends Fragment {
    ...
    public static SelectContactFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Contact weather_data[] = new Contact[]
                {
                        new Contact("test", "(11) 9.8885-6996"),
                        new Contact("test 2", "(11) 4.8885-6996"),
                        new Contact("test 3", "(11) 6.8885-6996"),
                        new Contact("test 4", "(11) 7.8885-6996"),
                };

        ContactAdapter adapter = new ContactAdapter(getContext(), R.layout.listview_item_row, weather_data);
